	...
	<div class="card-body">
        ...
        <table class="table table-stripped text-dark">
            ...
            <tbody>
                <?php 
                $i=1;
                    $qry = $conn->query("SELECT r.*,concat(u.name,' ',u.mobilenumber) as name, p.title FROM `rate_review` r inner join users u on .u.id = r.user_id inner join `packages` p on p.id = r.package_id order by unix_timestamp(r.date_created) desc ");
