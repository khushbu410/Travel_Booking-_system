        ...
        <hr class='border-primary'>
            <form action="" id="registration">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm form" name="Name" required>
                </div>
                <div class="form-group">
                    <label for="" class="control-label">Mobile Number</label>
                    <input type="" class="form-control form-control-sm form" name="mobilenumber" required>
                </div>
                <div class="form-group">
                    <label for="" class="control-label">Username</label>
